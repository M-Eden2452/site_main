...
//         '<img src="swimmer.png"/*tpa=http://static.topproducty.ru/img/swimmer.png*/ style="width:50px; height: 50px; float: left;padding-right: 10px;border:0;">' +
//         '������  ' + count + ' ������������� ������������� ��� �������� ������ � ����.' +
//         '</div>';
//     $(html).appendTo($(document.body));
